...
namespace BizHawk.Emulation.Cores.PCEngine
{
	...
	public sealed class VCE
	{
		...
		public void PrecomputePalette(int slot)
		{
			...
			// Just use Mesen2's PCE palette
			Palette[slot] = Colors.ARGB(FixedPalette[VceData[slot], 0], FixedPalette[VceData[slot], 1], FixedPalette[VceData[slot], 2]);
		}
